...
if(isset($_SESSION['user_name'])){
   header('Location: ../user_php/index.php');
   exit;
}
...
<div class="form-container" style="user-select: none">
   <form action="" method="post" style="max-width: 100%;">
      <h3 style="font-size: 130%;">Admin Login</h3>
      <?php
      if(isset($error)){
      ...
      <div style="text-align: left; justify-content: space-between; display: flex;">
         ...
         <a href="admin_lupa_password.php" style="font-size: 80%; text-decoration: none; color: #ff4d05;">Lupa Password?</a>
      </div>

      <div style="text-align: left;">
         <label style="font-size: 85%; user-select: none;"><input type="checkbox" name="remember" value="on" style="align-items: left; width: auto; margin-top: auto;" <?php if(isset($_COOKIE['email'])) { echo "checked"; } ?>> Remember me</label>
      </div>
      
      <input type="submit" name="submit" value="Login!" class="form-btn" style="font-size: 90%; margin-top: 10px;">
      </p>
      <p style="font-size: 90%; margin-top: -10px;">Belum punya akun? <a href="admin_register.php">Daftar Sekarang!</a></p>
   </form>
</div>
