      ...
      switch ($mode) {
         case 'enter_email':
            ...
            if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
               ...
               send_email($email);
               header("Location: admin_lupa_password.php?mode=enter_code");
               die;
            }
            break;
         ...
         case 'enter_code':
            ...
            if($result == "Kode benar!"){
               ...
               header('Location: admin_lupa_password.php?mode=enter_password');
               die;
            }else{
               $error[] = $result;
            }
         ...
         case 'enter_password':
            ...
            if($pass !== $cpass){
               ...
               header('Location: admin_lupa_password.php');
               die;
            }else{
               save_password($pass);
               ...
               echo '<script>alert("Password berhasil diubah!"); window.location.href = "admin_login.php";</script>';
               die;
            }
            break;
...
<?php
      ...
      switch ($mode) {
         case 'enter_email':
            # code...
            ?>
               <form action="admin_lupa_password.php?mode=enter_email" method="post" style="max-width: 100%;">
                  <h3 style="font-size: 130%;">Reset Password <span style="color: #ff4d05;">Admin</span></h3>
                  ...
                  <p style="font-size: 90%; margin-top: -10px;">Login <a href="admin_login.php">Sekarang!</a></p>
               </form>
            <?php
            break;
         ...
         case 'enter_code':
            # code...
            ?>
            <form action="admin_lupa_password.php?mode=enter_code" method="post" style="max-width: 100%;">
            ...
            <div style="text-align: right; display: block; margin-top: -5px; margin-bottom: -5px;">
               ...
               <input type="submit" name="submit" value="Next" class="form-btn" style="font-size: 90%; margin-top: 10px;">
               <a href="admin_lupa_password.php">
         ...
         case 'enter_password':
            # code...
            ?>
            <form action="admin_lupa_password.php?mode=enter_password" method="post" style="max-width: 100%;">
               <h3 style="font-size: 130%;">Reset Password</h3>
