...
<head>
    ...
    <!-- custom css link -->
    <link rel="stylesheet" type="text/css" href="../css/styleek.css">
...
<body>
    ...
    <section class="portofolio" id="portofolio" style="user-select: none;">
        <div class="main-text">
            ...
            <h2 style="font-size: 200%;"><span>Project</span> Terbaru</h2>
        </div>
        ...
        <div class="portofolio-content">
            ...
            <div class="row" style="width: auto; margin: 0 auto;">
                ...
                <div class="layer">
                    <h5 style="font-size: 85%;">Aplikasi Data Penjualan</h5>
                    <p style="font-size: 75%;">Desktop App Data Penjualan ini dibuat dengan bahasa Pemrograman JavaScript</p>
                    <a href="#"><i class='bx bx-link-external'></i></a>
                </div>
            </div>
